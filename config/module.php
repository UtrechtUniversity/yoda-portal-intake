...
$module['name'] 		= "intake";
$module['label'] 		= "Intake";
$module['glyph'] 		= "chevron-right";
$module['menu_order'] 	= 20;
$module['hide_menu']	= false;

$config['module-glyph'] = $module['glyph']; // Added as otherwise it cannot be loaded as being a config file. This entry is used for presenting the proper icon within reports-part of the module
